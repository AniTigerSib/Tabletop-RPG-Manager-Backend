...
import com.worfwint.tabletoprpgmanager.dto.response.NewsAuthorResponse;
...
import com.worfwint.tabletoprpgmanager.entity.NewsArticle;
import com.worfwint.tabletoprpgmanager.entity.NewsComment;
import com.worfwint.tabletoprpgmanager.entity.NewsLike;
...
import com.worfwint.tabletoprpgmanager.repository.NewsArticleRepository;
import com.worfwint.tabletoprpgmanager.repository.NewsCommentRepository;
import com.worfwint.tabletoprpgmanager.repository.NewsLikeRepository;
...
public class NewsService {
    ...
    public NewsDetailResponse getArticle(Long articleId, AuthenticatedUser currentUser) {
        ...
        boolean likedByCurrentUser = currentUser != null
                && newsLikeRepository.existsByArticleIdAndUserId(articleId, currentUser.getId());
    ...
    private Set<Long> resolveLikedArticleIds(AuthenticatedUser currentUser, Collection<Long> articleIds) {
        ...
        return newsLikeRepository.findArticleIdsLikedByUser(currentUser.getId(), articleIds);
    }
